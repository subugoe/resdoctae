...
-->
    ...
    <xsl:template match="dri:referenceSet[@id='aspect.artifactbrowser.ItemViewer.referenceSet.collection-viewer']/dri:reference" mode="summaryView">
        ...
        <xsl:comment> 11 External Metadata URL: <xsl:value-of select="$externalMetadataURL"/> </xsl:comment>
    ...
    <xsl:template match="dri:reference" mode="itemPageSummaryList">
        ...
        <xsl:comment> 2 External Metadata URL: <xsl:value-of select="$externalMetadataURL"/> </xsl:comment>
        <li>
    ...
    <xsl:template match="dri:reference" mode="summaryList">
        ...
        <xsl:comment> 7 External Metadata URL: <xsl:value-of select="$externalMetadataURL"/> </xsl:comment>
        <li>
    ...
    <xsl:template match="dri:reference" mode="detailList">
        ...
        <xsl:comment> 8 External Metadata URL: <xsl:value-of select="$externalMetadataURL"/> </xsl:comment>
        <li>
    ...
    <xsl:template match="dri:reference" mode="summaryView">
        ...
        <!-- This comment just displays the full URL in an HTML comment, for easy reference. -->
        <xsl:comment> 9 External Metadata URL: <xsl:value-of select="$externalMetadataURL"/> </xsl:comment>
        <xsl:apply-templates select="document($externalMetadataURL)" mode="summaryView"/>
        <xsl:apply-templates />
    </xsl:template>
    ...
    <xsl:template match="dri:reference" mode="detailView">
        ...
        <xsl:comment> 10 External Metadata URL: <xsl:value-of select="$externalMetadataURL"/> </xsl:comment>
