    ...
    <xsl:template name="buildHeader">
        ...
        <div class="container hidden-xs hidden-sm visible-md visible-lg" id="face-wrapper">
            ...
            <div id="ds-face-logo-text">
                ...
                <span class="secondary">Dokumentenserver der<br />Akademie der Wissenschaften zu Göttingen</span>
            </div>
	    <!--<div id="dini">
		<img src="/static/images/dini-zertifikat-klein.jpg" alt="dini certificate" /></div> -->
            <div id="clear"></div>
        </div>
    </xsl:template>
