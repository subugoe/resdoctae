...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHead">
	    ...
	    <meta content="D1T_OmihXbuSv5FhqohTaeyDjaOo_RlhX0jYVgW0TG0" name="google-site-verification" />
			...
			<xsl:text>/themes/Mirage2/images/favicon.ico</xsl:text>
                </xsl:attribute>
            </link>
	    ...
	    <xsl:variable name="page_title">
	        <xsl:choose>
                	<xsl:when test="contains(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='title'][last()], '# ')">
                        	<xsl:value-of select="substring-after(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='title'][last()], '# ')"/>
                	</xsl:when>
                	<xsl:otherwise>
                        	<xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='title'][last()]"/>
                	</xsl:otherwise>
		</xsl:choose>
	    </xsl:variable>
    ...
    <xsl:template name="buildHeader">
        ...
        <div class="container hidden-xs hidden-sm visible-md visible-lg" id="face-wrapper">
            ...
            <div id="ds-face-logo-text">
                <span class="primary">res doctae</span>
    ...
    <xsl:template name="buildFooter">
        <footer>
		    ...
		    <!-- <a>
                        <xsl:attribute name="href">
                            <xsl:value-of
                                    select="concat($adwPortalBaseURL, '/ueber-uns/datenschutzerklaerung')"/>
			</xsl:attribute> -->
	...
	<script type="text/javascript" src="/themes/Mirage2/scripts/theme.js">&#160;</script>
