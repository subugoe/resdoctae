...
<xsl:stylesheet
    ...
    <xsl:template match="dim:dim" mode="itemSummaryList-DIM-metadata">
        ...
        <div class="artifact-description">
			...
			<xsl:choose>
 			    <xsl:when test="dim:field[@element='description' and @qualifier='view']">
					<xsl:value-of select="dim:field[@element='description' and @qualifier='view']"/>
			    </xsl:when>
	    ...
	    <xsl:if test="not(//dim:field[@element='description' and @qualifier='view'])">
